...
const { register, login, deleteUser, postDoctor, getDoctorCard, getDoctorById, postPatient, getPatientCard, deletePatientCard, editPatientCard, getPatientById } = require('../Controller/authController');
