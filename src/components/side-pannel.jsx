      ...
      >
        <div className="app-brand demo">
          <a href="index.html" className="app-brand-link">
            ...
            <span className="app-brand-text demo menu-text fw-bolder ms-2 text-uppercase">
              Doctor
            </span>
          </a>
          <a
        ...
        <ul className="menu-inner py-1">
          ...
          <li className="menu-item">
            <div
              ...
              style={{ cursor: "pointer" }} // Optional: to make it look clickable
            >
            ...
            {/* Add CSS for the submenu visibility */}
            <style jsx>{`
              .menu-sub.hidden {
                display: none;
              }
          ...
          <li className="menu-item">
            <Link to="/patient-form" className="menu-link">
              <i className="menu-icon tf-icons bx bx-detail" />
              <div data-i18n="Form Elements">Patient Form</div>
            </Link>
          </li>
